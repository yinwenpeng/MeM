...
#             return updates
# 
#         updates = AdaGrad(self.loss, self.params, 0.5)
...
#             updates = adadelta(self.params, gradient)
            updates = []
            for param_i, grad_i in zip(self.params, gradient):
                updates.append((param_i, param_i - 0.01 * grad_i))   #AdaGrad
    ...
    def new_attention_step(self, ct, prev_g, mem, q_q):   #? prev_g is not used for this function
